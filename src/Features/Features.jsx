  ...
  return (
    <div name='features' className="h-auto w-full bg-features-bg bg-cover mt-[-9rem] px-5 pb-[14rem] pt-[10rem] md:mt-[-11rem] md:pt-[12rem] md:px-10 lg:mt-[-13rem] lg:pt-[12rem] xl:mt-[-15rem] xl:pt-[14rem] 2xl:mt-[-17rem] 2xl:pt-[17rem] 2xl:pb-[17rem]" >
       ...
       <div className='flex flex-col gap-[40px] w-full items-center md:gap-[40px] lg:flex-row lg:items-center lg:gap-[5rem]'>
          <div className='pt-[5rem] w-auto h-[15rem] flex justify-center items-center sm:h-[17rem] lg:w-[40%] xl:h-[20rem] 2xl:h-[25rem]'>
          ...
          <div className='w-full lg:w-[50%] lg:pt-[5rem]'>
            ...
            <h1 className='text-[32px] font-bold text-blue-color pb-3 sm:text-[34px]'>. . . Enjoy our Service Suits</h1>
            ...
            <p className='text-blue-color text-[22px] sm:text-[22px]'> - Provide a service on SoftPurse App.</p>
            <br />
            <p className='text-blue-color text-[22px] sm:text-[22px]'> - Book for Services on the App.</p>
            <p className='text-blue-color text-[22px] sm:text-[22px]'>. . . All-In-One App</p>
          </div>
       </div>
       <div className='flex flex-col-reverse gap-[30px] w-full items-center justify-center md:gap-[40px] lg:flex-row lg:items-center lg:gap-[5rem]'>
          ...
          <div className='pt-[5rem] 2sm:w-[12rem] 2sm:h-[20rem] w-[22rem] h-[25rem] flex justify-center items-center sm:h-[27rem] sm:w-[24rem] md:h-[29rem] md:w-[26rem] lg:w-[50%] xl:h-[32rem] 2xl:w-[45%] 2xl:h-[40rem]'>
       ...
       <div className='flex flex-col gap-[30px] w-full items-center md:gap-[40px] lg:flex-row lg:items-center lg:gap-[5rem]'>
          <div className='pt-[5rem] 2sm:w-[12rem] 2sm:h-[20rem] w-[20rem] h-[25rem] flex justify-center items-center sm:w-[22rem] sm:h-[27rem] lg:w-[40%] xl:h-[32rem] 2xl:h-[40rem]'>
          ...
          <div className='w-full lg:w-[50%] lg:pt-[5rem]'>
            ...
            <p className='text-blue-color text-[22px] sm:text-[22px]'>Choose from our multiple services and get connected to a professional to meet your service demand.</p>
          </div>
       </div>
    </div>
  )
