...
function Footer() {
  return (
    <div name='footer' className='w-full bg-footer-bg py-[4rem] flex flex-col items-center gap-[2rem]'>
        <div className='flex flex-col gap-[0.7rem] items-center md:flex-row'>
        ...
        <div className='w-[55%] flex flex-row gap-5 sm:gap-7 md:gap-9 lg:w-[40%] xl:w-[30%] 2xl:w-[20%]'>
            <div className='w-[16%] h-[2.5rem] sm:w-[20%] sm:h-[3.5rem] md:w-[25%] md:h-[4.5rem] cursor-pointer'>
