  ...
  return (
    <div name='steps' className='w-full h-auto bg-steps-bg bg-cover mt-[-16rem] pt-[19rem] px-5 pb-[10rem] sm:pb-[14rem] md:px-10 2xl:mt-[-17rem] 2xl:pb-[17rem]'>
        ...
        <div className='flex flex-wrap items-center justify-center xl:justify-normal gap-[2rem]'>
            <div className='w-[100%] h-[25rem] bg-whit rounded-lg relative 2sm:px-[15px] px-[20px] py-[20px] sm:px-[25px] sm:w-[70%] sm:h-[28rem] md:w-[45%] xl:w-[30%]'>
                ...
                <div className='flex flex-col gap-[15px]'>
                    ...
                    <div className=''>
                        <Slide direction={'up'} duration={1500} triggerOnce={true}>
                            <h2 className='text-[21px] font-bold sm:text-[23px] pb-2'>Download and Sign Up :</h2>
            ...
            <div className=' w-[100%] h-[25rem] bg-whit rounded-lg relative 2sm:px-[15px] px-[20px] py-[30px] sm:px-[25px] sm:w-[70%] md:w-[45%] xl:w-[30%] sm:h-[28rem]'>
                ...
                <div className='flex flex-col gap-[15px]'>
                    ...
                    <div className=''>
                        <Slide direction={'up'} duration={1500} triggerOnce={true}>
                            <h2 className='text-[21px] font-bold sm:text-[23px] pb-2'>Upgrade to Enjoy Our Extensive Services :</h2>
