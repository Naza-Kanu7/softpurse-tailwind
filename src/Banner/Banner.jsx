    ...
    <div name='home' className='w-full h-auto bg-banner-bg px-5 py-8 pb-[7rem] md:px-10 md:pb-[12rem]  lg:pb-[14rem]  xl:pb-[17rem]'>
        <div className='flex flex-col justify-between gap-[3rem] md:flex-row'>
            <div className='flex flex-col md:pt-[3rem] 2xl:pt-[5rem]'>
                ...
                <div className='flex 2sm:flex-col flex-row items-start gap-3 pt-4 sm:flex-row sm:pt-7 lg:gap-11 lg:pt-6 xl:pt-10 2xl:pt-12'>
                    ...
                    <div className='w-[9rem] 2sm:w-[9.7rem] h-[3.1rem] rounded-[10px] cursor-pointer sm:w-[10rem] sm:h-[4.1rem] md:w-[10rem] lg:w-[12rem] xl:w-[14rem]'>
